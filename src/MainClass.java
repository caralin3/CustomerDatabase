        ...
        public void run() {
            ...
            try {
                while(!quit) {
                    ...
                    OrderTable.insertOrder(mc.getConnection(), orders.getFoodItem());
                }
            } catch(Exception e) {
                e.printStackTrace();
            }
        ...
        public void run() {
            ...
            try {
                while(!quit) {
                    ...
                    OrderTable.deleteOrder(mc.getConnection(), orders);
                }
            } catch(Exception e) {
                e.printStackTrace();
            }
...
//        String location = "../_db/threadBase";
        ...
        try {
            ...
            OrderTable.createOrderTable(mc.getConnection());
            ...
            while(!quit) {
                ...
                if (!CustomerTable.selectCustomerName(mc.getConnection(),
                        new Customer(i, first[rand[0]], last[rand[1]], orderses[rand[2 % 50]]))) {
                    new Thread(new populate(first[rand[0]], last[rand[1]], orderses[rand[2 % 50]])).start();
                    new Thread(new service(i, first[rand[0]], last[rand[1]], orderses[rand[2 % 50]])).start();
                    i++;
                }
            }
